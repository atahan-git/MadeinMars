...
/// It sort of works...
/// This also exists in Utilities/, and I don't know why, and am too afraid to delete one of them
/// </summary>
public class PinchableScrollRect : ScrollRect {
    private const float _sizeFactor = 0.4f;
    float _minZoom = 0.1f * _sizeFactor;
    float _maxZoom = 4f *_sizeFactor;
    float _zoomLerpSpeed = 10f *_sizeFactor;
    ...
    protected override void Awake () {
        ...
        scaleFac = GetComponentInParent<Canvas>().GetComponent<RectTransform>().localScale.x;
        _currentZoom *= _sizeFactor;
    }
