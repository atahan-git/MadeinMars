...
#region Ports
        ...
        public NodePort GetPort(string fieldName) {
            if (ports.TryGetValue(fieldName, out var port)) return port;
            else return null;
        }
...
#region Attributes
        ...
        [Serializable] private class NodePortDictionary : SortedDictionary<string, NodePort>, ISerializationCallbackReceiver {
